...
namespace AirTechAPI.Server.Models
{
    public partial class AirTechAPIContext : DbContext
    {
        public AirTechAPIContext()
        {
        }

        public AirTechAPIContext(DbContextOptions<AirTechAPIContext> options, IConfiguration configuration)
            : base(options)
        {
